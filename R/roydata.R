#' Generalized Roy Data with Heterogenous Treatment Effects
#'
...
#' @docType data
#' @usage data(roydata)
#' @format The data contains the following information which would be observed in a standard dataset:
#' \describe{
...
#' Generalized Roy Data with Homogenous Treatment Effects
#'
