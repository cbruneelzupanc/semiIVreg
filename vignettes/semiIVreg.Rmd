...
Now, denote $\tilde{U}_d = U_d - E[U_d | D=d, \widehat{P}]$. We have $E[\tilde{U}_d | D=d,  \widehat{P}]] = 0$, so the no-intercept residual OLS regression give consistent estimates. 
-->
